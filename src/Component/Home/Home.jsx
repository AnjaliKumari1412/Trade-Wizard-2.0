...
import { IoMdPeople as Connect } from "react-icons/io"
import { AiOutlineDollarCircle as Dollar } from "react-icons/ai"
export default function Home() {
    ...
    function start_up() {
        ...
        const connect_card = document.querySelector(".card1")
        main_text.style.opacity = "1";
        main_text.style.transform = "translateX(0px)"
        main_head.style.opacity = "1";
        main_head.style.transform = "translateX(0px)"
        main_graph.style.fontSize = "400px"
        setTimeout(() => {
            connect_card.style.opacity = "1"
        }, 2000);
        ...
        <>
            ...
            <div id="Home">
                <div id="header">
                    ...
                    <div id="nav">
                        <div className="nav_item" data-text="web_text">Home</div>
                        <div className="nav_item" data-text="web_text">About</div>
                        <div className="nav_item" data-text="web_text">Blogs</div>

                        <button>
                            <span><Link to="/Sign">Sign In</Link></span>
                        </button>
                    </div>
                ...
                <div className="card">
                    ...
                    <div className="nav_item">Blogs</div>
                ...
                <div id="Main">
                    <div id="main_div">
                        <p id="main_head" data-text="web_text" >Stocks and Market</p>
                        <p id="main_text" data-text="web_text" >Unleashing the Power of Trades: Building Connections, Creating Futures, and Crafting Success Together.</p>
                        <div id="button_div">
                    ...
                    <Graph data-text="web_text" id="main_graph" />
                </div>
            </div >
            <div class="card1">
